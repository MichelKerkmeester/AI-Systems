...
7. **Report Completion**:
   ...
   - Create spike first if more research needed: `/speckit.spike`
   ```
...
- **Research First**: If decision needs more investigation, run `/speckit.spike` to research alternatives first
