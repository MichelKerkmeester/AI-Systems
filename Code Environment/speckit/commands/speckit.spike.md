...
The text the user typed after `/speckit.spike` in the triggering message **is** the research question or exploration topic. Use it as the basis for generating spike documentation.
