# Tasks: [FEATURE NAME] - Implementation Breakdown
...
- **Where**: [Test file locations - e.g., tests/unit/]
- **Coverage Target**: [e.g., 70-80% line coverage]

### Integration Tests
- **What**: [Integrations requiring testing - APIs, database, services]
- **Where**: [Test file locations - e.g., tests/integration/]
- **Coverage Target**: [e.g., All API endpoints, all DB operations]

### Test Data
- **Fixtures**: [Location and description of test fixtures]
- **Factories**: [Test data generation strategy]
- **Snapshots**: [Snapshot testing approach if applicable]

### Execution
- **Local**: [Command to run tests locally]
- **CI**: [When tests run in CI - e.g., on every PR]
