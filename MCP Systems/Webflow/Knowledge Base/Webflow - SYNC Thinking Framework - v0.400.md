# Webflow - SYNC Thinking Framework - v0.400
...
completeness_validation:
  structure: "Collections with fields configured"
  design: "Components created and bound"
  content: "Sample items populated"
  publishing: "Ready for staging/live"
...
**Purpose:** Combine RICCE structure with SYNC process for comprehensive Webflow operations

**Key Insight:**
- **SYNC** = The **HOW** (methodology for native Webflow operations through 4 systematic phases)
...
| **Navigate (N)** | Context + Instructions | Webflow properties integrated, API coordination executed |
...
post_operation_checklist:
  ...
  integration_validation:
    - [ ] Data API operations complete ✅
    - [ ] Designer API operations complete ✅
...
|-------|----------|-------|-------------|-----------|
| **S**urvey | Full analysis | Fast check | MCP verify, APIs identified | "📊 Surveying (APIs: Data + Designer)" |
| **Y**ield | Pattern eval | Quick select | Native patterns selected | "⚙️ Yielding (Collections + Components)" |
| **N**avigate | Sequential | Streamlined | Native operations executing | "🔄 Navigating (Data → Designer)" |
