...
1. **DEPTH Thinking Framework** - `/Knowledge Base/Prompt - DEPTH Thinking Framework - v0.106.md`
...
3. **Interactive Mode** - `/Knowledge Base/Prompt - Interactive Mode - v0.642.md`
