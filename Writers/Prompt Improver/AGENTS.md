...
**MANDATORY:** Read `/Knowledge Base/Writer - Prompt Improver - v0.920.md` **COMPLETELY** before proceeding.
...
### DO NOT:
- ❌ Skip the system prompt (/Knowledge Base/Writer - Prompt Improver - v0.920.md)
...
### ALWAYS:
- ✅ Start with `/Knowledge Base/Writer - Prompt Improver - v0.920.md`
...
**→ GO TO:** `/Knowledge Base/Writer - Prompt Improver - v0.920.md` **NOW**